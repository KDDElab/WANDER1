...
def get_parser(algorithm_name, parser):
    if algorithm_name == "aton":
        ...
        parser.add_argument('--alpha1', type=float, default=1.0, help='triplet loss factor in loss function')
        parser.add_argument('--alpha2', type=float, default=0.0, help='dis loss factor in loss function')
        ...
        parser.add_argument('--kernel', type=str, default='linear', help='')
