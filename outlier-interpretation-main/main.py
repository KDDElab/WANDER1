...
# od_eval_model = ["copod", "abod", "hbos", "ecod", "sod", "mcd"] # we obtain ground-truth annotations using three outlier detection methods
# od_eval_model = ["abod", "copod", "ecod", "hbos", "iforest", "lunar", "mcd", "rod", "sod"]
od_eval_model = ["abod","hbos", "sod","copod", "ecod"]
# od_eval_model = ["copod", "ecod", "hbos"]
runs = args.runs
...
def run_model(algorithm, X, y):
    if algorithm == "aton":
        ...
        #print("fea_weight_lst", len(fea_weight_lst))
